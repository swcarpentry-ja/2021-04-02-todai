...
### Aesthetic mapping
<br>
.center[<img src="https://clauswilke.com/dataviz/aesthetic_mapping_files/figure-html/temp-normals-vs-time-1.png" alt="drawing" height="350">]
...
### Aesthetic mapping
<br><br>
.center[<img src="https://clauswilke.com/dataviz/aesthetic_mapping_files/figure-html/four-locations-temps-by-month-1.png" alt="drawing" height="250">]
...
今までは平均余命とGDPの関係を下のコードで図を作ってきました：
...
このコードを変えて、時間による平均余命の変化を表す図を作ってください。
